...
/**
 * class that represent the user page of staff (Camp Creator)
 * @author Anqi
 * @date 2023/11/22
 */
public class StaffCampCreatorPage extends User implements CampAttendant, ApplicationPage, ViewerOfCampInfo, ViewerOfSomeCamps {
    /**
     * constructor of StaffCampCreatorPage
     * @param userID
     * @param email
     * @param name
     * @param faculty
    ...
    /**
     * show list of Camps that staff has created
     */
    @Override
     ...
     * @throws InvalidUserInputException classthatrepresenttheInvalidUserInputException
     */
    @Override
    ...
    /**
     * edit the detail of certain camp
     * @throws InvalidUserInputException classthatrepresenttheInvalidUserInputException
     */
    ...
    /**
     * generate Performance Report of camp
     * @throws InvalidUserInputException classthatrepresenttheInvalidUserInputException
     */
